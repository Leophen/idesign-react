...
import type { PopperInstance } from '../_shared/popper';
import '../_shared/popper';
...
const Popup: React.FC<PopupProps> = (props) => {
  ...
  const updateContentRef = (ref: React.Ref<HTMLDivElement>) => {
    if (typeof ref === 'function') {
      return;
    }
    contentRef.current = ref?.current ?? null;
  };
  ...
  return (
    <>
      <div
        className={classNames('i-popup__reference', className)}
        style={{ ...style }}
        ref={referenceRef}
      ...
      <Transition timeout={200} in={innerVisible && !disabled} animation="fade-in" key="i-popover">
        <Portal
