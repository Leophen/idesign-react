...
const Scrollbar: React.FC<ScrollbarProps> = (props) => {
  const { children, height, width, onScrollX, onScrollY } = props;
  ...
  return (
    ...
    >
      ...
      {height && (
        <div className="i-scrollbar__barY" onClick={handleClickBarY}>
          <Transition
            timeout={200}
      ...
      {width && (
        <div className="i-scrollbar__barX" onClick={handleClickBarX}>
          <Transition
            timeout={200}
            in={hoverShowThumb || downShowThumb}
            animation="fade-in"
