...
// 创建气泡提示容器
let popoverWrapper = document.querySelector('#i-popover-wrapper')
if (!popoverWrapper) {
  popoverWrapper = document.createElement('div')
  popoverWrapper.className = 'i-popover-wrapper'
  popoverWrapper.id = 'i-popover-wrapper'
...
const Portal: React.FC<PortalProps> = (props) => {
  ...
  const getLocationStyle = (placement: placementType, trigger: PortalProps, popover: PortalProps) => {
  ...
  return (
    ReactDOM.createPortal(PopoverNode, popoverWrapper as HTMLElement)
  )
}
